...
class HADARMultipleScenes():
    ...
    def __init__(self, root='/home/min/a/sureshbs/Desktop/TeXNet/Dataset/',
        ...
        if fold is None:
            ...
            train_ids = ["L_0001", "L_0002", "L_0003", "L_0004"]
            train_ids += ["R_0001", "R_0002", "R_0003", "R_0004"]
            val_ids = ["L_0006", "R_0006"] # 自己设置的样本对应的序号
            test_ids = ["L_0006", "R_0006"]
            train_exp_ids = ["L_0001", "L_0002", "L_0003"]
            train_exp_ids += ["R_0001", "R_0002", "R_0003"]
            val_exp_ids = ["L_0006", "R_0006"] # 自己设置的样本对应的序号
            test_exp_ids = ["L_0006", "R_0006"]
        ...
        # Test for different heatcube's size. Use a heathube file with different size  in Scene1 only  
        if fold == 5:
            SUBFOLDERS = [1]
